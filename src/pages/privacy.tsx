  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-sm md:prose-base max-w-none">
        ...
        <p>
          This Privacy Policy describes how Inlits ("we", "our", or "us")
        ...
        <ul>
          ...
          <li>Post content on our Service</li>
          <li>Participate in surveys or promotions</li>
        </ul>

        <p>
          This information may include your name, email address, password,
          profile information, payment information, and any other information
        ...
        <ul>
          <li>
            ...
            your use of the Service, including the type of browser you use,
          ...
          <li>
            ...
            your interactions with the Service, such as the content you view,
          ...
          <li>
            ...
            about your location when you access or use our Service, including
            precise location data with your consent.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Between and among Inlits and our current and future parents,
        ...
        <p>
          ...
          by logging into your online account and modifying your information or
          by emailing us at privacy@inlits.com. We may retain certain
        ...
        <p>
          You may opt out of receiving promotional emails from Inlits by
        ...
        <p>
          ...
          other than the country in which you initially provided the information
          for the purposes described in this Privacy Policy. If you are located
          in the European Economic Area (EEA) or the United Kingdom, we will
        ...
        <ul>
          ...
          <li>
            ...
            transmit it to a third party (data portability)
          </li>
          <li>
        ...
        <p>
          To exercise these rights, please contact us at privacy@inlits.com.
        </p>
        ...
        <p>
          Email:{" "}
          <a
            href="mailto:privacy@inlits.com"
